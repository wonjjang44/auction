...
public class QWallet extends EntityPathBase<Wallet> {
    ...
    private static final long serialVersionUID = -1929591685L;
    ...
    public final ListPath<com.tasksprints.auction.domain.payment.model.Payment, com.tasksprints.auction.domain.payment.model.QPayment> payments = this.<com.tasksprints.auction.domain.payment.model.Payment, com.tasksprints.auction.domain.payment.model.QPayment>createList("payments", com.tasksprints.auction.domain.payment.model.Payment.class, com.tasksprints.auction.domain.payment.model.QPayment.class, PathInits.DIRECT2);
